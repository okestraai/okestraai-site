      ...
      >
        <div className="container mx-auto px-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/customers" className="text-gray-700 hover:text-indigo-600 transition">
              Customers
            </Link>
        ...
        {isOpen && (
          ...
          >
            <div className="container mx-auto px-4 py-4 flex flex-col space-y-4">
              <Link href="/product" className="text-gray-700 py-2 hover:text-indigo-600 transition">
                Product
              </Link>
              <Link href="/solutions" className="text-gray-700 py-2 hover:text-indigo-600 transition">
                Solutions
              </Link>
              <Link href="/customers" className="text-gray-700 py-2 hover:text-indigo-600 transition">
                Customers
              </Link>
              <Link href="/about" className="text-gray-700 py-2 hover:text-indigo-600 transition">
                About
              </Link>
              <button
                onClick={() => setIsModalOpen(true)} // Open modal on click
